    ...
    <div className="contact-section-wrapper">
      ...
      <div className="contact-inner-parent">
        <Header header={header} />
          ...
          <p className="mb-5 BluetextUnderHeading">Select your trial criteria you wish to filter by</p>
          ...
          <button className="light-theme-btn  mb-3"  onClick={handleDropdownButton}>
             Determine Patient's Eligibilty <br /> for Trials <i class="fa fa-angle-right" aria-hidden="true"></i>
          </button>
          {showDropdown && (
